...
public class ExpenseService {
    ...
    public Page<Expense> findAll(Pageable pageable) {
        ...
        return expenseRepository
                .findByUserOrderByCreationDateDesc(
                        getCurrentUser(),
                        sortedPageable
                );    }
    ...
    public void deleteById(Long id) {
        ...
        Expense expenseToBeDeleted = findByIdForCurrentUser(id);

        System.out.println("Found = " + expenseToBeDeleted);
    ...
    public Page<Expense> getExpensesByYearMonthAndType(int year, Month month, String expenseType, Pageable page) {
        ...
        return expenseRepository
                .findByUserAndDateBetweenAndExpenseTypeOrderByCreationDateDesc(
                        getCurrentUser(),
                        startDate,
                        endDate,
                        expenseType,
    ...
    public Page<Expense> getExpensesByYearMonth(int year, Month month, Pageable page) {
        ...
        LocalDate endDate = startDate.withDayOfMonth(startDate.lengthOfMonth());
        return expenseRepository
                .findByUserAndDateBetweenOrderByCreationDateDesc(
                        getCurrentUser(),
                        startDate,
                        endDate,
                        page);
    ...
    public Page<Expense> getExpensesByType(String expenseType, Pageable page) {
    	return expenseRepository
    	        .findByUserAndExpenseTypeOrderByCreationDateDesc(
    	                getCurrentUser(),
    	                expenseType,
    	                page);
    }
    ...
    public Page<Expense> getCurrentUserExpenses(
            Pageable pageable) {
    ...
    public Expense findByIdForCurrentUser(Long id) {
