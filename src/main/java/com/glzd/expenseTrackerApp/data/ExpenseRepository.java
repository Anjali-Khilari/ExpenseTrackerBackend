...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
	...
	Page<Expense> findByUserAndExpenseTypeOrderByCreationDateDesc(
	        User user,
	        String expenseType,
	        Pageable pageable);
	
	Page<Expense> findByUserAndDateBetweenOrderByCreationDateDesc(
	        User user,
	        LocalDate startDate,
	        LocalDate endDate,
	        Pageable pageable);
	
	Page<Expense> findByUserAndDateBetweenAndExpenseTypeOrderByCreationDateDesc(
	        User user,
	        LocalDate startDate,
	        LocalDate endDate,
	        String expenseType,
    ...
    Page<Expense> findByUserOrderByCreationDateDesc(User user,Pageable pageable);
